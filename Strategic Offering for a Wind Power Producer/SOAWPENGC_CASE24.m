...
legend('wind unit 1', 'Location', 'north');
% print('GC cleared', '-dsvg');

figure(4)
plot(value(alphawGC(:, 1, 1)), '-o');
...
legend('day-ahead', 'balacing', 'green certificate', 'total');
